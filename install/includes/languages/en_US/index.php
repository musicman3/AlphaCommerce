...
page_title_welcome = Welcome to RuBiC (Online Shopping)!
...
text_welcome = <p>RuBiC (Online Shopping) is an Open Source online shop e-commerce solution that is available for free under the GNU General Public License. It features a rich set of out-of-the-box online shopping cart functionality that allows store owners to setup, run, and maintain online stores with minimum effort and with no costs, fees, or limitations involved.</p>
text_installation_type = Please choose the installation method to continue.

server_requirements_php = PHP v5.2+ (with MySQLi extension)
server_requirements_mysql = MySQL v4.1.13+ or v5.0.7+
...
box_server_allow_url_fopen = allow_url_fopen
box_server_session_auto_start = session.auto_start
box_server_session_use_trans_sid = session.use_trans_sid
box_session_use_only_cookies = session.use_only_cookies
box_server_php_extensions = PHP Extensions
box_server_mysqli = MySQLi
box_server_json = Json
box_server_mbstring = Mbstring
box_server_SimpleXML = SimpleXML
box_server_gd = GD
box_server_imagick = ImageMagick
