...
INSERT INTO osc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) VALUES ('Country', 'STORE_COUNTRY', '223', 'The country my store is located in <br /><br /><b>Note: Please remember to update the store zone.</b>', '1', '6', 'osC_AddressClass::getCountryName', 'osc_cfg_set_countries_pulldown_menu', now());
INSERT INTO osc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) VALUES ('Zone', 'STORE_ZONE', '4031', 'The zone my store is located in', '1', '7', 'osC_AddressClass::getZoneName', 'osc_cfg_set_zones_pulldown_menu', now());
...
INSERT INTO osc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('Turn off the shop for maintenance', 'MAINTENANCE_MODE', '-1', 'You want to shut shop for service?', 1, 22, now(), 'osc_cfg_use_get_boolean_value', 'osc_cfg_set_boolean_value(array(1, -1))');
...
INSERT INTO osc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('The pixel width of heading category images', 'HEADING_IMAGE_WIDTH', '90', 'The pixel width of heading images', '4', '3', now());
INSERT INTO osc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('The pixel height of heading category images', 'HEADING_IMAGE_HEIGHT', '80', 'The pixel height of heading images', '4', '4', now());
INSERT INTO osc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) VALUES ('Image Required', 'IMAGE_REQUIRED', '1', 'Enable to display broken images. Good for development.', '4', '5', 'osc_cfg_use_get_boolean_value', 'osc_cfg_set_boolean_value(array(1, -1))', now());
INSERT INTO osc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('The pixel height of heading icon images', 'HEADING_IMAGE_HEIGHT_ICON', '30', 'The pixel of heading images', '4', '6', now());
...
INSERT INTO osc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Default Template', 'DEFAULT_TEMPLATE', 'richer_designs', 'Default Template', '6', '0', now());

INSERT INTO osc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) VALUES ('Country of Origin', 'SHIPPING_ORIGIN_COUNTRY', '223', 'Select the country of origin to be used in shipping quotes.', '7', '1', 'osC_AddressClass::getCountryName', 'osc_cfg_set_countries_pulldown_menu', now());
...
INSERT INTO osc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('CMS Page List Size', 'MAX_DISPLAY_CMS_ARTICLES', '5', 'The number of cms articles to display on one page.', 6, 0, now());
INSERT INTO osc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('CMS Box List Size', 'BOX_CMS_LIST_SIZE', '5', 'The number of cms articles to display in box.', 6, 0, now());
INSERT INTO osc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('List Articles with topics', 'MODULE_CONTENT_ARTICLES_TOPIC_DISPLAY', '-1', 'Display articles in topics?', 6, 0, now(), 'osc_cfg_use_get_boolean_value', 'osc_cfg_set_boolean_value(array(1, -1))');
INSERT INTO osc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Interval (ms)', 'MODULE_CONTENT_SLIDE_SHOW_INTERVAL', '5000', 'slide show interval', 6, 0, now());
INSERT INTO osc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Duration (ms)', 'MODULE_CONTENT_SLIDE_SHOW_DURATION', '1000', 'slide show duration', 6, 0, now());
INSERT INTO osc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Image height (px)', 'MODULE_CONTENT_SLIDE_SHOW_HEIGHT', '210', 'Image height', 6, 0, now());
INSERT INTO osc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Image width (px)', 'MODULE_CONTENT_SLIDE_SHOW_WIDTH', '960', 'Image width', 6, 0, now());
INSERT INTO osc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, set_function) VALUES ('Slide show mode', 'MODULE_CONTENT_SLIDE_SHOW_MODE', 'random', 'Slideshow Mode', 6, 0, now(), 'osc_cfg_set_boolean_value(array(''random'', ''scrollUp'', ''scrollDown'', ''scrollLeft'', ''scrollRight'', ''fade'', ''growX'', ''growY'', ''zoom'', ''zoomFade'', ''zoomTL'', ''zoomBR''))');
INSERT INTO osc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('Shopping Cart Listing of new products', 'NEW_PRODUCTS_CART', '-1', 'You want to use a cart in the listing of new products?', 9, 11, now(), 'osc_cfg_use_get_boolean_value', 'osc_cfg_set_boolean_value(array(1, -1))');
...
INSERT INTO osc_products_images_groups values (2, 1, 'Thumbnails', 'thumbnails', 104, 78, 0);
INSERT INTO osc_products_images_groups values (3, 1, 'Product Information Page', 'product_info', 192, 144, 0);
INSERT INTO osc_products_images_groups values (4, 1, 'Large', 'large', 1024, 768, 0);
INSERT INTO osc_products_images_groups values (5, 1, 'Mini', 'mini', 52, 39, 0);
...
INSERT INTO osc_templates_boxes VALUES (22,'Templates','templates','osCommerce','http://www.oscommerce.com','boxes');
INSERT INTO osc_templates_boxes VALUES (23,'Slideshow','slide_show','osCommerce','http://www.oscommerce.com','content');
INSERT INTO osc_templates_boxes VALUES (24,'Articles','cms','Box 25','http://www.box25.net','boxes');
INSERT INTO osc_templates_boxes VALUES (25,'Articles','cms_sitemap','Gergely','http://www.oscommerce-extra.hu','content');
INSERT INTO osc_templates_boxes VALUES (26,'Attached articles','cms_xsell','Gergely','http://www.oscommerce-extra.hu','content');
INSERT INTO osc_templates_boxes VALUES (27,'Attached products','cms_xsell_products','Gergely','http://www.oscommerce-extra.hu','content');
INSERT INTO osc_templates_boxes VALUES (28,'Ordering Steps','checkout_trail','osCommerce','http://www.oscommerce.com','content');
...
#Info
INSERT INTO osc_info (info_id, language_id, info_name, info_description, active, date_added, last_modified, sort_order) VALUES (1, 1, 'Privacy Statement', 'Put here the required information.', 1, now(), 0, 2);
INSERT INTO osc_info (info_id, language_id, info_name, info_description, active, date_added, last_modified, sort_order) VALUES (2, 1, 'Terms and Conditions', 'Put here the required information.', 1, now(), 0, 3);
INSERT INTO osc_info (info_id, language_id, info_name, info_description, active, date_added, last_modified, sort_order) VALUES (3, 1, 'Shipping and Returns', 'Put here the required information.', 1, now(), 0, 1);
