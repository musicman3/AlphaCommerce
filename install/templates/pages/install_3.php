...
<!--
  ...
  function prepareDB() {
    if (document.getElementById("DB_INSERT_SAMPLE_DATA").checked) {
      ...
      loadXMLDoc("rpc_<?php echo $osC_Language->getCode(); ?>.php?action=dbImportSample&server=" + urlEncode(dbServer) + "&username=" + urlEncode(dbUsername) + "&password=" + urlEncode(dbPassword) + "&name=" + urlEncode(dbName) + "&class=" + urlEncode(dbClass) + "&prefix=" + urlEncode(dbPrefix), handleHttpResponse);
    } else {
...
<div class="contentBlock">
  ...
  <div class="contentPane">
    <h3><?php echo $osC_Language->get('page_heading_step_3'); ?></h3>
