...
<script type="text/javascript" src="../includes/javascript/xmlhttp/xmlhttp.js"></script>
<script type="text/javascript" src="../includes/javascript/xmlhttp/autocomplete.js"></script>
...
<!--
  ...
  function prepareWork() {
    ...
    loadXMLDoc("rpc_<?php echo $osC_Language->getCode(); ?>.php?action=checkWorkDir&dir=" + urlEncode(cfgWork), handleHttpResponse);
  }
...
<div class="contentBlock">
  ...
  <div class="contentPane">
    <h3><?php echo $osC_Language->get('page_heading_step_2'); ?></h3>
    ...
    <table border="0" width="99%" cellspacing="0" cellpadding="5" class="inputForm">
      ...
      <tr>
        <td class="inputField"><?php echo $osC_Language->get('param_web_work_directory') . '<br /><span style="white-space: nowrap;">' . osc_draw_input_field('HTTP_WORK_DIRECTORY', $dir_fs_www_root . 'includes/work', 'class="text"'); ?>&nbsp;<img src="images/progress_pending.gif" border="0" width="16" height="16" id="HTTP_WORK_DIRECTORY_icon" /></span><div class="autoComplete" id="divAutoComplete"></div></td>
