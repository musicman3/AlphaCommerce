...
INSERT INTO osc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Ширина основного изображения категорий в пикселях', 'HEADING_IMAGE_WIDTH', '120', 'Ширина основного изображения в пикселях', '4', '3', now());
INSERT INTO osc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Высота основного изображения категорий в пикселях', 'HEADING_IMAGE_HEIGHT', '90', 'Высота основного изображения в пикселях', '4', '4', now());
INSERT INTO osc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) VALUES ('Необходимое изображение', 'IMAGE_REQUIRED', '1', 'Включите эту функцию для принудительного отображения испорченных изображений. Удобно для отладки.', '4', '8', 'osc_cfg_use_get_boolean_value', 'osc_cfg_set_boolean_value(array(1, -1))', now());
