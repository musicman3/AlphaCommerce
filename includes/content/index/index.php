...
/* Class constructor */
    ...
    function osC_Index_Index() {
      global $osC_Database, $osC_Services, $osC_Language, $osC_Breadcrumb, $cPath, $cPath_array, $current_category_id, $osC_Category, $osC_Session;

      $this->_page_title = STORE_NAME;
      ...
      if (isset($cPath) && (empty($cPath) === false)) {
        ...
        if ( $osC_Category->hasImage() ) {
          $this->_page_image = 'categories/mini/' . $osC_Category->getImage();
        }
