 ...
 */
    ...
    protected $_page_tags = array('generator' => array('RuBiC, osCommerce, Open Source E-Commerce Solutions'));
 ...
 */
	  ...
	  function osc_draw_image_jquery_button_buy($params) {
			static $button_counter = 1;
      global $osC_Language;
      ...
      $button = '<button id="button_buy' . $button_counter . '" type="' . osc_output_string($params['type']) . '"';

			if ( isset($params['buy']) ) {
				$button .= ' onclick="buy(\''.$params['buy'].'\')"';
			}
      ...
      $button .= '>' . $params['title'] . '</button><script type="text/javascript">$("#button_buy' . $button_counter . '").button(';
	  ...
	  function osc_draw_image_jquery_button_click($params) {
			static $button_counter = 1;
      global $osC_Language;
      ...
      if ( ($params['type'] == 'button') && isset($params['href']) ) {
        $params['type'] = 'button';
      }

      $button = '<button id="button_click' . $button_counter . '" type="' . osc_output_string($params['type']) . '"';
      ...
      $button .= '>' . $params['title'] . '</button><script type="text/javascript">$("#button_click' . $button_counter . '").button(';
      ...
      return $button;
		...
		function osc_draw_image_jquery_button_go($params) {
			static $button_counter = 1;
      global $osC_Language;
      ...
      $button = '<button id="button_go' . $button_counter . '" type="' . osc_output_string($params['type']) . '"';

			if ( isset($params['go']) ) {
				$button .= ' onclick="document.location.href=\'' . $params['go'] . '\';"';
			}
      ...
      $button .= '>' . $params['title'] . '</button><script type="text/javascript">$("#button_go' . $button_counter . '").button(';
