...
*/
  ...
  class osC_Boxes_best_sellers extends osC_Modules {
    ...
    function initialize() {
      global $osC_Database, $osC_Language, $current_category_id, $osC_Template;
      ...
      if ($Qbestsellers->numberOfRows() >= BOX_BEST_SELLERS_MIN_LIST) {
        ...
        while ($Qbestsellers->next()) {
          $this->_content .= '<li>' . osc_image('templates/' . $osC_Template->getCode() . '/images/arrow_gray.png') . '&nbsp;' . osc_link_object(osc_href_link(FILENAME_PRODUCTS, $Qbestsellers->value('products_keyword')), $Qbestsellers->value('products_name')) . '</li>';
        }
