...
?>
<style type="text/css"><!--
	.dataDashboard THEAD TH
	{
		padding: 3px 10px;
		border-bottom: 1px solid #333;
		font-weight: bold;
	}
	.dataDashboard TBODY TD
	{
		padding: 3px 10px;
	}
	.dataDashboard TR.mouseOver TD, .dataDashboard TR.mouseOverDeactivatedRow TD
	{
		background-color: #b9dcff;
	}
	.dataDashboard TR.deactivatedRow TD
	{
...
<!-- Autoupdate page start -->
<script type="text/javascript">
	$.ajaxSetup ({
		cache: false
	});
	jQuery(document).ready(function(){
		setInterval("jQuery('#timeA').load('# span#timeA');",120000);
	});
</script>
<!-- Autoupdate page -->
