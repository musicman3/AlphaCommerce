...
<table border="0" width="100%" cellspacing="0" cellpadding="2" class="dataTable">
  <thead>
    <tr>
      <th align="left"><?php echo $osC_Language->get('table_heading_newsletters'); ?></th>
      <th align="center"><?php echo $osC_Language->get('table_heading_size'); ?></th>
      <th align="left"><?php echo $osC_Language->get('table_heading_module'); ?></th>
      <th align="center"><?php echo $osC_Language->get('table_heading_sent'); ?></th>
...
?>
    ...
    <tr onmouseover="rowOverEffect(this);" onmouseout="rowOutEffect(this);">
      ...
      <td align="center"><?php echo number_format($Qnewsletters->valueInt('content_length')); ?></td>
      <td align="left"><?php echo $$newsletter_module_class->getTitle(); ?></td>
