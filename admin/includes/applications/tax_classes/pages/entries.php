...
<table border="0" width="100%" cellspacing="0" cellpadding="2" class="dataTable" id="taxClassEntriesDataTable">
  <thead>
    <tr>
      <th align="left" width="100"><?php echo $osC_Language->get('table_heading_tax_rate_priority'); ?></th>
      <th align="left"><?php echo $osC_Language->get('table_heading_tax_rate_zone'); ?></th>
