...
?>
    ...
    <div><p><?php echo osc_image('../' . DIR_WS_IMAGES . 'categories/' . $osC_ObjectInfo->get('categories_image'), $osC_ObjectInfo->get('categories_name'), '100%', '100%') . '<br />' . DIR_WS_CATALOG . 'images/categories/' . $osC_ObjectInfo->getProtected('categories_image'); ?></p></div>
