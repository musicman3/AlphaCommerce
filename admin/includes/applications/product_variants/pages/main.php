...
<?php
  while ( $Qgroups->next() ) {
    $Qentries = $osC_Database->query('select count(*) as total from :table_products_variants_values where products_variants_groups_id = :products_variants_groups_id and languages_id = :languages_id');
