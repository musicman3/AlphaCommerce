...
<table border="0" width="100%" cellspacing="0" cellpadding="2" class="dataTable">
  <thead>
    <tr>
      ...
      <th align="left"><?php echo $osC_Language->get('table_heading_price'); ?></th>
...
?>
    ...
    <tr onmouseover="rowOverEffect(this);" onmouseout="rowOutEffect(this);" <?php echo (($Qspecials->valueInt('status') !== 1) ? 'class="deactivatedRow"' : '') ?>>
      ...
      <td align="left"><span class="oldPrice"><?php echo $osC_Currencies->format($Qspecials->value('products_price')); ?></span> <span class="specialPrice"><?php echo $osC_Currencies->format($Qspecials->value('specials_new_products_price')); ?></span></td>
      <td align="right">
