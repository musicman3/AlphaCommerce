...
<?php
  echo $osC_Language->get('operation_title_search') . ' ' . osc_draw_input_field('search') . '<input type="submit" value= "' . $osC_Language->get('button_use') . '" class="operationButton" />' .
...
<table border="0" width="100%" cellspacing="0" cellpadding="2" class="dataTable">
  <thead>
    <tr>
      <th width="20">&nbsp;</th>
	  <th align="left"><?php echo $osC_Language->get('table_heading_first_name'); ?></th>
      <th align="left"><?php echo $osC_Language->get('table_heading_last_name'); ?></th>
