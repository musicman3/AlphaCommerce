...
*/
  ...
  class img_upload {
    ...
    function img_upload($file = '', $destination = '', $permissions = '777', $extensions = '') {
      $this->set_file($file);
    ...
    function save() {
	  ...
	  $times = time();
      if (move_uploaded_file($this->file['tmp_name'], $this->destination . $times.'_'.$this->filename)) {
        chmod($this->destination . $times.'_'.$this->filename, $this->permissions);
