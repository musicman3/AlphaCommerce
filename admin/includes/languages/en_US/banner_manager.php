...
subsection_heading_statistics_daily = <b>%s</b> - Daily Statistics For %s %s
subsection_heading_statistics_monthly = <b>%s</b> - Monthly Statistics For %s
subsection_heading_statistics_yearly = <b>%s</b> - Yearly Statistics

field_title = Title:
field_url = URL:
field_group = Group:
field_group_new = (468x60 and etc), or enter a new group below
field_image = Image:
