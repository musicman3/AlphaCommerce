 ...
 */
    ...
    function osC_Payment_authorizenet_cc() {
	  ...
	  $title1 = $osC_Language->get('payment_authorizenet_cc_admin_1');
	  $title2 = $osC_Language->get('payment_authorizenet_cc_admin_2');
	  $title3 = $osC_Language->get('payment_authorizenet_cc_admin_3');
	  $title4 = $osC_Language->get('payment_authorizenet_cc_admin_4');
	  $title5 = $osC_Language->get('payment_authorizenet_cc_admin_5');
	  $title6 = $osC_Language->get('payment_authorizenet_cc_admin_6');
	  $title7 = $osC_Language->get('payment_authorizenet_cc_admin_7');
	  $title8 = $osC_Language->get('payment_authorizenet_cc_admin_8');
	  $title9 = $osC_Language->get('payment_authorizenet_cc_admin_9');
	  $title10 = $osC_Language->get('payment_authorizenet_cc_admin_10');
	  $title11 = $osC_Language->get('payment_authorizenet_cc_admin_11');
	  $title12 = $osC_Language->get('payment_authorizenet_cc_admin_12');
	  $title13 = $osC_Language->get('payment_authorizenet_cc_admin_13');
	  $title14 = $osC_Language->get('payment_authorizenet_cc_admin_14');
	  $title15 = $osC_Language->get('payment_authorizenet_cc_admin_15');
	  $title16 = $osC_Language->get('payment_authorizenet_cc_admin_16');
	  $title17 = $osC_Language->get('payment_authorizenet_cc_admin_17');
	  $title18 = $osC_Language->get('payment_authorizenet_cc_admin_18');
	  $title19 = $osC_Language->get('payment_authorizenet_cc_admin_19');
	  $title20 = $osC_Language->get('payment_authorizenet_cc_admin_20');
	  $title21 = $osC_Language->get('payment_authorizenet_cc_admin_21');
	  $title22 = $osC_Language->get('payment_authorizenet_cc_admin_22');	
	...
	if (($configuration_title & $configuration_description) != ($titlex & $titley)) {		  
	  ...
	  $osC_Database->simpleQuery("UPDATE " . TABLE_CONFIGURATION . " SET configuration_title = '$title1', configuration_description = '$title12' WHERE configuration_key = 'MODULE_PAYMENT_AUTHORIZENET_CC_STATUS'");
	  $osC_Database->simpleQuery("UPDATE " . TABLE_CONFIGURATION . " SET configuration_title = '$title2', configuration_description = '$title13' WHERE configuration_key = 'MODULE_PAYMENT_AUTHORIZENET_CC_LOGIN_ID'");
	  $osC_Database->simpleQuery("UPDATE " . TABLE_CONFIGURATION . " SET configuration_title = '$title3', configuration_description = '$title14' WHERE configuration_key = 'MODULE_PAYMENT_AUTHORIZENET_CC_TRANSACTION_KEY'");
	  $osC_Database->simpleQuery("UPDATE " . TABLE_CONFIGURATION . " SET configuration_title = '$title4', configuration_description = '$title15' WHERE configuration_key = 'MODULE_PAYMENT_AUTHORIZENET_CC_MD5_HASH'");
	  $osC_Database->simpleQuery("UPDATE " . TABLE_CONFIGURATION . " SET configuration_title = '$title5', configuration_description = '$title16' WHERE configuration_key = 'MODULE_PAYMENT_AUTHORIZENET_CC_ACCEPTED_TYPES'");
	  $osC_Database->simpleQuery("UPDATE " . TABLE_CONFIGURATION . " SET configuration_title = '$title6', configuration_description = '$title17' WHERE configuration_key = 'MODULE_PAYMENT_AUTHORIZENET_CC_VERIFY_WITH_CVC'");
	  $osC_Database->simpleQuery("UPDATE " . TABLE_CONFIGURATION . " SET configuration_title = '$title7', configuration_description = '$title18' WHERE configuration_key = 'MODULE_PAYMENT_AUTHORIZENET_CC_TRANSACTION_SERVER'");
	  $osC_Database->simpleQuery("UPDATE " . TABLE_CONFIGURATION . " SET configuration_title = '$title8', configuration_description = '$title19' WHERE configuration_key = 'MODULE_PAYMENT_AUTHORIZENET_CC_TRANSACTION_TEST_MODE'");	  
	  $osC_Database->simpleQuery("UPDATE " . TABLE_CONFIGURATION . " SET configuration_title = '$title9', configuration_description = '$title20' WHERE configuration_key = 'MODULE_PAYMENT_AUTHORIZENET_CC_ZONE'");
	  $osC_Database->simpleQuery("UPDATE " . TABLE_CONFIGURATION . " SET configuration_title = '$title10', configuration_description = '$title21' WHERE configuration_key = 'MODULE_PAYMENT_AUTHORIZENET_CC_ORDER_STATUS_ID'");
	  $osC_Database->simpleQuery("UPDATE " . TABLE_CONFIGURATION . " SET configuration_title = '$title11', configuration_description = '$title22' WHERE configuration_key = 'MODULE_PAYMENT_AUTHORIZENET_CC_SORT_ORDER'");	  
 ...
 */
    ...
    function install() {
      ...
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Transaction Server', 'MODULE_PAYMENT_AUTHORIZENET_CC_TRANSACTION_SERVER', '12', 'Perform transactions on the production server or on the testing server.', '6', '0', 'osc_cfg_set_boolean_value(array(13, 18, 12))', now())");
