 ...
 */
    ...
    function osC_Payment_saferpay_vt() {
	  ...
	  $title1 = $osC_Language->get('payment_saferpay_vt_admin_1');
	  $title2 = $osC_Language->get('payment_saferpay_vt_admin_2');
	  $title3 = $osC_Language->get('payment_saferpay_vt_admin_3');
	  $title4 = $osC_Language->get('payment_saferpay_vt_admin_4');
	  $title5 = $osC_Language->get('payment_saferpay_vt_admin_5');
	  $title6 = $osC_Language->get('payment_saferpay_vt_admin_6');
	  $title7 = $osC_Language->get('payment_saferpay_vt_admin_7');
	  $title8 = $osC_Language->get('payment_saferpay_vt_admin_8');
	  $title9 = $osC_Language->get('payment_saferpay_vt_admin_9');
	  $title10 = $osC_Language->get('payment_saferpay_vt_admin_10');
	  $title11 = $osC_Language->get('payment_saferpay_vt_admin_11');
	  $title12 = $osC_Language->get('payment_saferpay_vt_admin_12');
	...
	if (($configuration_title & $configuration_description) != ($titlex & $titley)) {		  
	  ...
	  $osC_Database->simpleQuery("UPDATE " . TABLE_CONFIGURATION . " SET configuration_title = '$title1', configuration_description = '$title7' WHERE configuration_key = 'MODULE_PAYMENT_SAFERPAY_VT_STATUS'");
	  $osC_Database->simpleQuery("UPDATE " . TABLE_CONFIGURATION . " SET configuration_title = '$title2', configuration_description = '$title8' WHERE configuration_key = 'MODULE_PAYMENT_SAFERPAY_VT_ACCOUNT_ID'");
	  $osC_Database->simpleQuery("UPDATE " . TABLE_CONFIGURATION . " SET configuration_title = '$title3', configuration_description = '$title9' WHERE configuration_key = 'MODULE_PAYMENT_SAFERPAY_VT_PASSWORD'");
	  $osC_Database->simpleQuery("UPDATE " . TABLE_CONFIGURATION . " SET configuration_title = '$title4', configuration_description = '$title10' WHERE configuration_key = 'MODULE_PAYMENT_SAFERPAY_VT_ZONE'");
	  $osC_Database->simpleQuery("UPDATE " . TABLE_CONFIGURATION . " SET configuration_title = '$title5', configuration_description = '$title11' WHERE configuration_key = 'MODULE_PAYMENT_SAFERPAY_VT_ORDER_STATUS_ID'");
	  $osC_Database->simpleQuery("UPDATE " . TABLE_CONFIGURATION . " SET configuration_title = '$title6', configuration_description = '$title12' WHERE configuration_key = 'MODULE_PAYMENT_SAFERPAY_VT_SORT_ORDER'");	
