...
/* Private methods */
    ...
    function _setData() {
      ...
      $this->_data = '<table border="0" width="100%" cellspacing="0" cellpadding="2" class="dataTable">' .
                     '  <thead>' .
                     '    <tr>' .
                     '      <th align="left">' . $osC_Language->get('summary_administrators_log_table_heading_users') . '</th>' .
                     '      <th align="left">' . $osC_Language->get('summary_administrators_log_table_heading_module') . '</th>' .
                     '      <th align="center">' . $osC_Language->get('summary_administrators_log_table_heading_date') . '</th>' .
                     '    </tr>' .
                     '  </thead>' .
                     '  <tbody>';
      ...
      while ( $Qlog->next() ) {
        $this->_data .= '    <tr onmouseover="rowOverEffect(this);" onmouseout="rowOutEffect(this);">' .
                        ...
                        '      <td align="center">' . $Qlog->value('datestamp') . '</td>' .
                        '    </tr>';
      }
