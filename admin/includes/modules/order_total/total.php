...
*/
  ...
  class osC_OrderTotal_total extends osC_OrderTotal_Admin {
    ...
    function osC_OrderTotal_total() {
	  ...
	  $title1 = $osC_Language->get('order_total_total_admin_1');
	  $title2 = $osC_Language->get('order_total_total_admin_2');
	  $title3 = $osC_Language->get('order_total_total_admin_3');
	  $title4 = $osC_Language->get('order_total_total_admin_4');
	...
	if (($configuration_title & $configuration_description) != ($titlex & $titley)) {		  
	  ...
	  $osC_Database->simpleQuery("UPDATE " . TABLE_CONFIGURATION . " SET configuration_title = '$title1', configuration_description = '$title3' WHERE configuration_key = 'MODULE_ORDER_TOTAL_TOTAL_STATUS'");
	  $osC_Database->simpleQuery("UPDATE " . TABLE_CONFIGURATION . " SET configuration_title = '$title2', configuration_description = '$title4' WHERE configuration_key = 'MODULE_ORDER_TOTAL_TOTAL_SORT_ORDER'");		
    ...
    function install() {
      ...
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Display Total', 'MODULE_ORDER_TOTAL_TOTAL_STATUS', '1', 'Do you want to display the total order value?', '6', '1', 'osc_cfg_set_boolean_value(array(1, -1))', now())");
