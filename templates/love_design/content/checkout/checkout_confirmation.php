...
?>
              ...
              <tr>
                <td colspan="2"><?php echo '<b>' . $osC_Language->get('order_products_title') . '</b> ' . osc_link_object(osc_href_link(FILENAME_CHECKOUT, null), '<span class="orderEdit">' . $osC_Language->get('order_text_edit_title') . '</span>'); ?></td>
...
?>
              ...
              <tr>
                <td colspan="3"><?php echo '<b>' . $osC_Language->get('order_products_title') . '</b> ' . osc_link_object(osc_href_link(FILENAME_CHECKOUT, null), '<span class="orderEdit">' . $osC_Language->get('order_text_edit_title') . '</span>'); ?></td>
              </tr>
